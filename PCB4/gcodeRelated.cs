...
namespace PCB_DR
{
    public static class gcode
    {
        ...
        {
            float segmentLength = 1f; // (float)Properties.Settings.Default.importGCLineSegmentLength;
            bool equidistance = true; // Properties.Settings.Default.importGCLineSegmentEquidistant;
